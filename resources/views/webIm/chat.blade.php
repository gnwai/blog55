<html><head>
    ...
    <link href="/web/chat/css/bootstrap.min.css" rel="stylesheet">
    <link href="/web/chat/css/jquery-sinaEmotion-2.1.0.min.css" rel="stylesheet">
    <link href="/web/chat/css/style.css" rel="stylesheet">

    <script type="text/javascript" src="/web/chat/js/swfobject.js"></script>
    <script type="text/javascript" src="/web/chat/js/web_socket.js"></script>
    <script type="text/javascript" src="/web/chat/js/jquery.min.js"></script>
    <script type="text/javascript" src="/web/chat/js/jquery-sinaEmotion-2.1.0.min.js"></script>
